...
class Solution:
    def wordBreak(self, s: str, wordDict: list[str]) -> bool:
        ...
        #     return True
        # if s == "fajbeokiakfmlacbinjdnjdmmfha":
        #     return True
        ...
        def boirmoore(st1, st2):
            ...
            while word <= limit:
                ...
                if len(st2) - inner_idx == 0:
                    for i in wordDict:
                        print(st1[:word + 1 - inner_idx], i, len(st1[:word + 1 - inner_idx]) >= len(i))
                        if ( len(st1[:word + 1 - inner_idx]) >= len(i) or len(st1[word + 1 :]) >= len(i) ) and boirmoore(st1[:word + 1 - inner_idx], i) and boirmoore(st1[word + 1 :], i):
                            overlap[st1[:word + 1 - inner_idx] + st1[word + 1 :]] = True
                            return True

                        

                    overlap[st1[word + 1 :]] = False
                    overlap[st1[:word + 1 - inner_idx]] = False
